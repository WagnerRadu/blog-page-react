...
export default function Article({title, tag, author, date, imgUrl, content, id, editArticle, deleteArticle}: Props) {
  return (
    <article className='article'>
      ...
      <div className='edit-container'>
        <button className='edit-button' onClick={() => editArticle({title, tag, author, date, imgUrl, content, id})}>Edit</button>
